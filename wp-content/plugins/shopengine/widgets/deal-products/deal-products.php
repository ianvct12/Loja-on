	...
	protected function register_controls() {
	  ...
	  $this->add_control(
		...
		*/ 
		...
		$this->add_control(
			'shopengine_deal_product_show_cart_btn',
			[
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.rtl {{WRAPPER}} .shopengine-deal-products-widget .shopengine-offer-badge' => 'border-radius: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'.rtl {{WRAPPER}} .shopengine-deal-products-widget .shopengine-offer-badge' => 'right: {{SIZE}}{{UNIT}};width:fit-content;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'.rtl {{WRAPPER}} .shopengine-deal-products-widget .shopengine-sale-badge' => 'right: {{SIZE}}{{UNIT}};width:fit-content;',
				],
			]
		);
        ...
        */
            ...
            $this->start_controls_section (
				'shopengine_product_add_to_cart_style',
				[
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'selector' => '{{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button',
                'fields_options'    => [
                    'typography'     => [
                        'default' => 'custom',
                    ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#FFFFFF',
                'selectors' => [
                    '{{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button'   => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#3E3E3E',
                'selectors' => [
                    '{{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button'   => 'background: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#FFFFFF',
                'selectors' => [
                    '{{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button:hover'   => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#F54F29',
                'selectors' => [
                    '{{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button:hover'   => 'background: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' 	=> [
                    '{{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '.rtl {{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'fields_options' => [
                    ...
                    'width'      => [
                        'selectors' => [
                            '{{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                            '.rtl {{WRAPPER}} .shopengine-deal-products-widget .add-to-cart-bt .button' => 'border-width: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}}',
                        ]
                    ]
                ],
            ]
