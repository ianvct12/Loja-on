      ...
      <ol class="commentlist">
         <li class="review byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-16">
            <div id="comment-16" class="comment_container">
               <img alt="<?php esc_attr_e('avatar','shopengine'); ?>" src="https://secure.gravatar.com/avatar/7064f941bf63e90bfe35449c62586bc8?s=60&d=mm&r=g" class="avatar avatar-60 photo" height="60" width="60" loading="lazy">
	...
	<div id="review_form_wrapper">
		<div id="review_form">
			<div id="respond" class="comment-respond">
				...
				Add a review 
				<small><a title="<?php esc_html_e('Comment Replay Cancel','shopengine')?>" rel="nofollow" id="cancel-comment-reply-link" href="#" style="display:none;">Cancel reply</a></small>
				</span>
				<form action="#" method="post" id="commentform" class="comment-form" novalidate="">
					...
					<p class="stars">
						<span>
						<a title="<?php esc_html_e('One Star','shopengine')?>" class="star-1" href="javascript:void(0)">1</a>
						<a title="<?php esc_html_e('Two Star','shopengine')?>" class="star-2" href="javascript:void(0)">2</a>
						<a title="<?php esc_html_e('Three Star','shopengine')?>" class="star-3" href="javascript:void(0)">3</a>
						<a title="<?php esc_html_e('Four Star','shopengine')?>" class="star-4" href="javascript:void(0)">4</a>
						<a title="<?php esc_html_e('Five Star','shopengine')?>" class="star-5" href="javascript:void(0)">5</a>
						</span>
					</p>
