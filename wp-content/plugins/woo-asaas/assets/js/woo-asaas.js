 ...
 * @package WooAsaas
 */
var copyToClipboardButton = document.querySelector('.woocommerce-order-details__asaas-pix-button');

if (null !== copyToClipboardButton) {
  var payloadCode = document.querySelector('.woocommerce-order-details__asaas-pix-payload');
  var defaultButtonText = copyToClipboardButton.textContent;
  var successCopiedButtonText = copyToClipboardButton.getAttribute('data-success-copy');
...
;// CONCATENATED MODULE: ./app/assets/js/components/mask-input.js
/**
...
external_jQuery_default()(document).on('ready updated_checkout', function () {
  var inputs = document.querySelectorAll('.payment_method_asaas-credit-card input.input-text');
...
// EXTERNAL MODULE: ./app/assets/js/components/copy-to-clipboard.js
var copy_to_clipboard = __webpack_require__(833);
;// CONCATENATED MODULE: ./app/assets/js/components/one-click-buy-option.js
/**
...
external_jQuery_default()(document).ajaxComplete(function () {
  var creditCardOptions = external_jQuery_default()('[name="asaas_cc_options"]');

  if (0 !== creditCardOptions.length) {
    var ccFormWrapper = external_jQuery_default()('.one-click-buy-option .asaas-cc-form-wrapper');
    creditCardOptions.on('change', function (event) {
...
;// CONCATENATED MODULE: ./app/assets/js/app.js
/**
 * Plugin JS file
 *
...
;// CONCATENATED MODULE: ./app/assets/main.js
// App
